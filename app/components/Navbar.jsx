...
export default function Navbar() {
  ...
  // ✅ New States for Language Switcher
  const [langOpen, setLangOpen] = useState(false);
  // ✅ Use Global Context (keep langOpen local)
    ...
    <>
          ...
          <div className="hidden md:flex items-center gap-10 text-slate-700 font-medium">
            ...
            <div className="relative hidden md:block">
              <button
                ...
                // Adjusted colors for white background visibility
                className="flex h-8 w-8 items-center justify-center rounded-md border border-gray-300 hover:bg-gray-100 transition"
              >
                🌍
              </button>
      ...
      {menuOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-[80%] max-w-[320px] bg-white z-[1001] shadow-xl p-6 flex flex-col gap-6 overflow-y-auto">
            <button
              onClick={() => setMenuOpen(false)}
            ...
            <div className="border-t pt-4">
              <button
                ...
                className="flex items-center gap-2 text-lg font-semibold text-blue-700 hover:text-blue-500 transition w-full"
              >
                🌍 Language
              </button>

              {langOpen && (
                <div className="mt-2 ml-4 flex flex-col gap-3 border-l-2 border-blue-100 pl-4">
                  {languages.map(([code, label]) => (
                    <button
                      key={code}
                      onClick={() => {
            ...
            {!username && (
              <button
                ...
                className="text-blue-600 font-semibold text-left mt-2"
              >
                Log In
              </button>
            )}
...
//   key={code}
//   onClick={() => {
//     changeLanguage(code); // 👈 THIS UPDATES THE WHOLE APP
//     setLangOpen(false);
//   }}
//   className={`block w-full px-4 py-2 text-left hover:bg-gray-100 text-sm ${
//     language === code ? "bg-blue-50 text-blue-600 font-semibold" : ""
//   }`}
// >
//   {label}
// </button>
